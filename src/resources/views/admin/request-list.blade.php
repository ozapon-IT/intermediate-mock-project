...
<main>
    <div class="request-list">
        ...
        <x-tabs
            :status="$status"
            route-name="admin.request-list.show"
        ...
        <x-request-list-table
            ...
            :detailRoute="fn($attendanceCorrection) => route('admin.approve-request.show', ['attendance_correct_request' => $attendanceCorrection->id])"
        />
    </div>
</main>
@endsection